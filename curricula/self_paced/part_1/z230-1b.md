...
you had just commited your new script file that reads in the data from file as a string.
...
You should now be familiar with lists and list indexing, dictionaries and their keys, 
ranges, for-loops, floats, and the Python commands split, append, and get. 
