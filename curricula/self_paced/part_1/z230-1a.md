...
code using Python best practices. Part 1 is designed to take 
...
things are done the way they done along the way. We will also 
incorporate lessons on the use of git because we highly 
recommend version controling of your work.
...
17. [python] You probably won't need to run your Hello World 
   ...
   include `'w'`, for example, if you wanted to write to the 
   file.
